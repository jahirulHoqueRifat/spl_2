...
public class WaterFall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name=getResources().getStringArray(R.array.waterfall_name);
        address=getResources().getStringArray(R.array.waterfall_address);
        rating=getResources().getStringArray(R.array.waterfall_rating);
