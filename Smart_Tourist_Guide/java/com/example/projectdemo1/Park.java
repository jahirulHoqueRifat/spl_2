...
public class Park extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name=getResources().getStringArray(R.array.park_name);
        address=getResources().getStringArray(R.array.park_address);
        rating=getResources().getStringArray(R.array.park_rating);
