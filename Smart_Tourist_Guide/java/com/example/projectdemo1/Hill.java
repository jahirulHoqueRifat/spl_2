...
public class Hill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name=getResources().getStringArray(R.array.hill_name);
        address=getResources().getStringArray(R.array.hill_address);
        rating=getResources().getStringArray(R.array.hill_rating);
