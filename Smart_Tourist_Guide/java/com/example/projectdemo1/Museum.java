...
public class Museum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name=getResources().getStringArray(R.array.museum_name);
        address=getResources().getStringArray(R.array.museum_address);
        rating=getResources().getStringArray(R.array.museum_rating);
