...
public class Zoo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name=getResources().getStringArray(R.array.zoo_name);
        address=getResources().getStringArray(R.array.zoo_address);
        rating=getResources().getStringArray(R.array.zoo_rating);
